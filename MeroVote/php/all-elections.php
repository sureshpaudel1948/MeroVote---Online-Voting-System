    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <!-- Brand -->
                <a class="navbar-brand" href="all-elections.php">MeroVote - Online
                    Voting Portal</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="all-elections.php">Home</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card shadow-sm border-success">
                            <div class="card-header bg-success text-white d-flex justify-content-between">
                                <!-- <span><?php echo htmlspecialchars($election['election_type']); ?></span> -->
                                <span
                                    class="badge bg-light text-success"><?php echo htmlspecialchars($election['election_type']); ?></span>
                            </div>
                            <div class="card-body">
